...
userRouter.put("/update-user-quizzes", auth_1.isAuthenticated, user_controller_1.updateUserQuizzes);
...
userRouter.get("/get-admin-users", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("Admin"), user_controller_1.getAllUsres);
