...
exports.updateUserQuizzes = exports.deleteUser = exports.updateUserRole = exports.getAllUsres = exports.updateProfilePicture = exports.updateUserPassword = exports.updateUserInfo = exports.socialAuth = exports.getUserInfo = exports.updateAccessToken = exports.logoutUser = exports.loginUser = exports.activateUser = exports.registrationUser = void 0;
...
exports.updateUserQuizzes = (0, catchAsyncErrors_1.catchAsyncErrors)(async (req, res, next) => {
    const quizResults = req.body;
    if (!mongoose_1.default.Types.ObjectId.isValid(quizResults?.quiz_id)) {
        return next(new ErrorHandler_1.default('Quiz id is not valide', 404));
    }
    ;
    const userId = req.user?._id;
    const user = await user_model_1.default.findById(userId);
